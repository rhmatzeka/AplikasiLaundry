...
<body class="bg-slate-50 text-slate-800 relative min-h-screen overflow-x-hidden">
    ...
    <div class="pt-28 pb-12 px-6 max-w-4xl mx-auto">
        ...
        <div class="space-y-6">
            ...
            <?php 
            while($o = $stmt->fetch()): 
                // Format Tanggal (jika kolom created_at ada, gunakan itu. Jika tidak, pakai placeholder)
            ...
            <div class="bg-white p-6 md:p-8 rounded-3xl shadow-lg border border-slate-100 hover:shadow-xl transition duration-300 group relative overflow-hidden" data-aos="fade-up">
                ...
                <div class="flex items-start gap-3 ml-4 text-slate-600">
                ...
                <div class="mt-6 ml-4 pt-4 border-t border-slate-100 flex justify-end">
                    <button class="text-sm font-bold text-blue-600 hover:text-blue-700 flex items-center gap-2 transition">
